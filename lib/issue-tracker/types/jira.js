...
jiraIssueTracker.listProjects = function (callback) {
    ...
    this.jira.listProjects().then(function (projects) {
...
jiraIssueTracker.prepareCustomFields = function () {
    if(jiraIssueTracker.options.customFields) {
        var i, j, projectsCount, fieldsCount;
        this.customFields = {};
        ...
        for (i = 0; i < projectsCount; i++) {
            ...
            for(j = 0; j < fieldsCount; j++) {
                ...
                this.customFields[project.projectKey]["customfield_" + field.id] = field.defaultValue;
            }
        }
    }
};
